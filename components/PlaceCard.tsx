...
export default function PlaceCard({ name, image, tag ,id}: Props) {
  ...
  return (
    ...
    >
      ...
      <button className="absolute bottom-2 right-2 px-3 py-1 bg-lime-300 text-black rounded-full hover:bg-lime-400 transition-all duration-300 cursor-pointer"
